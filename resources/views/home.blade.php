                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Campaign Sent">Drivers</h5>
                                <h3 class="my-2 py-1">{{  $countdriver }}</h3>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="New Leads">Buses</h5>
                                <h3 class="my-2 py-1">{{  $countvehicle }}</h3>
                                <p class="mb-0 text-muted">
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Deals">Parents</h5>
                                <h3 class="my-2 py-1">{{  $countfather }}</h3>
                                <p class="mb-0 text-muted">
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h5 class="text-muted fw-normal mt-0 text-truncate" title="Booked Revenue">Children</h5>
                                <h3 class="my-2 py-1">{{ $countchild }}</h3>
                                <p class="mb-0 text-muted">
